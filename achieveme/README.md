...
The app includes a **Help** page (top nav and Library header) with guides for discovery, sync, scoring, and FAQ. Contextual **?** tooltips appear on Dashboard stats, Library Refresh, Settings sections, and game detail controls. First launch shows a welcome dialog; the Library shows a one-time long-press tip.
