...
test('STEAM_WEB_API_KEY_URL points at the Steam Web API key form', () => {
  assert.equal(STEAM_WEB_API_KEY_URL, 'https://steamcommunity.com/dev/apikey')
})
